...
def main():
    ...
    parser.add_argument(
        "-p", "--problem", default="mirror", help="The name of the problem to solve"
    )
    parser.add_argument(
        "-a", "--algorithm", default="incremental", help="Specifies the algorithm"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-n", "--number", default=1, type=int, help="The number of blocks"
    )
    parser.add_argument(
