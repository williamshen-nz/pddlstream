...
def create_optimizer(
    ...
    def fn(outputs, facts, hint={}):
        ...
        get_var = (
            lambda p: var_from_param[p] if is_parameter(p) else p
        )  # var_from_param.get(p, p)
        ...
        print(
            "Objective: {:.3f} | Solutions: {} | Status: {}".format(
        ...
        if (
            not model.solCount
        ):  # GRB.INFEASIBLE | GRB.INF_OR_UNBD | OPTIMAL | SUBOPTIMAL | UNBOUNDED
