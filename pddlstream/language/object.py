...
class Object(object):
    ...
    def __init__(self, value, stream_instance=None, name=None):
        ...
        self.stream_instance = (
            stream_instance  # TODO: store first created stream instance
        )
...
class UniqueOptValue(
    namedtuple("UniqueOptTuple", ["instance", "sequence_index", "output"])
):
    @property
    def parameter(self):
...
class SharedOptValue(
    namedtuple("SharedOptTuple", ["stream", "inputs", "input_objects", "output"])
):
    @property
    def values(self):
...
class DebugValue(object):  # TODO: could just do an object
    ...
    def __repr__(self):
        ...
        return "{}{}{}".format(
            self._prefix, get_parameter_name(self.output_parameter), self.index
        )
...
class OptimisticObject(object):
    ...
    def __init__(self, value, param):
        ...
        if USE_OPT_STR and isinstance(self.param, UniqueOptValue):
            ...
            self.repr_name = "{}{}{}".format(
                OPT_PREFIX, prefix, var_index
            )  # self.index)
